...
public:
  ...
  Shader(const std::string &vsPath, const std::string &gsPath,
         const std::string &fsPath);
  void init(const std::string &vsPath, const std::string &fsPath);
  void init(const std::string &vsPath, const std::string &gsPath,
            const std::string &fsPath);
   ...
   */
  void initWithCode(const std::string &vs, const std::string &gs,
                    const std::string &fs);
...
inline Shader::Shader(const std::string &vsPath, const std::string &fsPath) {
  init(vsPath, fsPath);
}
inline Shader::Shader(const std::string &vsPath, const std::string &gsPath,
               const std::string &fsPath) {
  init(vsPath, gsPath, fsPath);
}

inline void Shader::init(const std::string &vsPath, const std::string &fsPath) {
  initWithCode(getCodeFromFile(vsPath), getCodeFromFile(fsPath));
}
inline void Shader::init(const std::string &vsPath, const std::string &gsPath,
                  const std::string &fsPath) {
  initWithCode(getCodeFromFile(vsPath), getCodeFromFile(gsPath),
               getCodeFromFile(fsPath));
}
inline void Shader::initWithCode(const std::string &vs, const std::string &fs) {
...
inline void Shader::initWithCode(const std::string &vs, const std::string &gs,
                          const std::string &fs) {
  // TODO: filling this function to set shaders to OpenGL
...
inline std::string Shader::getCodeFromFile(const std::string &path) {
  std::string code;
  std::ifstream file;
...
inline void Shader::use() const { glUseProgram(id); }
...
inline void Shader::setMat3(const std::string &name, const glm::mat3 &value) const {
